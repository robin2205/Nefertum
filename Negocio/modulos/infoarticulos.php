...
while($fila=mysqli_fetch_array($sql)){
  ...
  ->setCellValue('B'.$i,$fila['DescripcionArticulo']);
  $i++;}
...
$objPHP->getActiveSheet()->getColumnDimension('B')->setWidth(70);
